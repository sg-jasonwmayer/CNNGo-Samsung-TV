(function(){
    ...
    var sources = ['http://media.w3.org/2010/05/sintel/trailer.mp4', 'https://cdn.theoplayer.com/video/big_buck_bunny/big_buck_bunny_metadata.m3u8'];
    var currentSource = 0;
    var player = null;
    var hPlayer = null;
    ...
    window.onload = function () {
        ...
        registerKeys();
        registerKeyHandler();
    	hPlayer = createPlayer();
        log('Appended');
        document.querySelector('.left').appendChild(hPlayer);
        log('BEFORE THEO PLAYER');
        player = theoplayer(hPlayer);
        log('AFTER THEO PLAYER');
...
theoplayer.onReady = function () {
	console.log("HEY THE THEO PLAYER ON LOAD IS GETTING CALED");
}