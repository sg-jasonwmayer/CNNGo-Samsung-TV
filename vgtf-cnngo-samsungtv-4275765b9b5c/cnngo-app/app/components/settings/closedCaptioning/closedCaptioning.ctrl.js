(function() {
   ...
   angular.module('closedCaptioning.controller', []).controller('closedCaptioningController',
      closedCaptioningController);

   function closedCaptioningController($rootScope, $scope, $state) {
      console.log('Inside the closedCaptioning controller');

      
      // //Write your target video's url
      // var videoUrl = "";
      // //If you use remote url for subtitle. remain as ""
      // var subtitleUrl = "";
      // //If you use local subtitle file, internal subtitle. remain as ""
      ...
      //          //You use local external subtitle
